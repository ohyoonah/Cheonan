...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.CustomViewHolder> {
    ...
    public CustomAdapter(ArrayList<Tour> arrayList, Context context) {
    ...
    class CustomViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        void onBind(Tour tour, int position){
            this.tour = tour;
            this.position = position;

            tv_name.setText(tour.getTxt());
            tv_address.setText(tour.getTxt());
        ...
        public void onClick(View v) {
            switch (v.getId()){
                ...
                case R.id.iv_image:
                    Toast.makeText(context, tour.getTxt(), Toast.LENGTH_SHORT).show();
                    break;
